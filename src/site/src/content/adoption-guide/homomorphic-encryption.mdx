...
- **_Fully homomorphic encryption:_** premits arbitrary operations on encryption data.
...
| <OutboundLink href="https://fhe-website.mybluemix.net">IBM FHE Toolkits</OutboundLink>                         | iOS, MacOS, Linux, and Android Toolkits for integreating homomorphic encryption in desktop and mobile applications                                                                                                                                       |
