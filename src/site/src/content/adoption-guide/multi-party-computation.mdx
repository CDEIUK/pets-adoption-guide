...
- There is direct network connectivity between each of the parties involved in the data processing
- You want to derive specific results from the collective data of the parties involved, without them explicitly sharing their raw data

Using a multi-party computation protocol is therefore a possible solution, as this enables computations to be performed across data held by multiple organisations whilst each organisation's raw data remains confidential
