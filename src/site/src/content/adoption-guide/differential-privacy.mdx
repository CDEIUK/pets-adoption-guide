...
Your answers to the questions in the Adoption Guide indicate that you want to generate and publish insights derived from a dataset.

In his case, differential privacy could be considered. Differential privacy allows insights derived from raw data to be shared, whilst providing a mathematical guarantee on the amount of information that can be inferred about any individual row in the dataset.

## Limitations to consider

- Choosing a suitable valuable for the privacy budget is often challenging and highly context-specific.
- For differential privacy to work well, you will likely need to be using structured data with a large sample size.
