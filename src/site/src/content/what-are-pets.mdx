...
- Partial homomorphic encryption: permits only a single type of operation (e.g. addition) on encrypted data.
- Somewhat homomorphic encryption: permits some combinations of operations (e.g. some additions and multiplications) on encrypted data.
- Fully homomorphic encryption: premits arbitrary operations on encryption data.
